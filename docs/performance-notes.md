...
These notes capture the current dashboard + contacts + companies slice, not the finished CRM port.
...
## Current Dashboard + Contacts + Companies Measurements
...
| `public/packs/js/generated/AtomicCrmCompaniesPage.js` | `1,579 B` | `563 B` |
| `public/packs/js/generated/AtomicCrmCompanyShowPage.js` | `1,595 B` | `569 B` |
| `public/packs/js/generated/AtomicCrmDealBoardIsland.js` | `5,035 B` | `1,304 B` |
| `public/packs/css/application.css` | `10,494 B` | `2,484 B` |
| `ssr-generated/rsc-bundle.js` | `435,338 B` | `71,634 B` |
| `ssr-generated/server-bundle.js` | `2,206,119 B` | n/a |
...
| `/companies` | `159.574 ms`, `38.940 ms`, `30.408 ms`, `34.887 ms`, `23.209 ms` |
| `/companies/1` | `153.901 ms`, `26.037 ms`, `28.984 ms`, `34.525 ms`, `32.667 ms` |
...
| `/companies` | `9-19 ms` | `0.9-1.0 ms` | `7` |
| `/companies/1` | `19-20 ms` | `1.2-1.3 ms` | `9` |
...
wc -c \
  ...
  public/packs/js/generated/AtomicCrmCompaniesPage.js \
  public/packs/js/generated/AtomicCrmCompanyShowPage.js \
...
gzip -c public/packs/js/generated/AtomicCrmCompaniesPage.js | wc -c
gzip -c public/packs/js/generated/AtomicCrmCompanyShowPage.js | wc -c
...
npm run bench:home -- http://127.0.0.1:3000/companies
npm run bench:home -- http://127.0.0.1:3000/companies/1
```
...
- the companies list and detail routes stay in the same `1.5 kB` range while adding another route family
...
- compare route-level JavaScript shipped for dashboard, contacts list, contact detail, companies list, company detail, and the future deal routes
