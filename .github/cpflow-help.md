...
example `v5.1.1`, so `CPFLOW_VERSION` can validate against a semantic release.
...
git ls-remote https://github.com/shakacode/control-plane-flow.git refs/tags/v5.1.1
bin/pin-cpflow-github-ref --checkout-ref <40-character-control-plane-flow-commit-sha> v5.1.1
